...
model = pickle.load(open(r'C:\Users\DELL\Downloads\Machine Learning\simple linear regression model .pym', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Shubham Mahakalkar")